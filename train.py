from trainer.trainer import run_epoch
from models.model_zoo import Conv2DGRU
from datasets.dataset import BaseDataset
from utils import get_all_song_names, create_kfold_splits
...
def main(cfg):
    ...
    for fold_idx, fold in enumerate(folds):
        ...
        test_loss, test_acc, test_f1 = run_epoch(test_loader, model, optimizer, criterion, device, train=False)
